...
Instrucciones
	...
	hay que correr los siguientes scripts:
		...
		python preguntas/pregunta_dos_parte_a.py
		
		python preguntas/pregunta_dos_parte_b.py
	...
	homicidios, hay que correr los siguientes scripts:
		...
		python preguntas/pregunta_dos_crimen_parte_a.py
		
		python preguntas/pregunta_dos_crimen_parte_b.py
