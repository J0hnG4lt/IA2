...
if __name__ == '__main__':
	...
	#Inverting matrix to have a distance matrix instead of similarity
	for lang in condMatrix:
		for lang2 in condMatrix[lang]:
	 		condMatrix[lang][lang2] = 1 - condMatrix[lang][lang2]

	# Making de distance matrix symmetric using max "distance"
	...
	dataset.to_csv("corridas/ProbabilidadCondicional/MatrizProbabilidadCondicional.csv",
						float_format="%.2f")
